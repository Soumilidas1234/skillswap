-- Milestone certificates per category + level ranges
USE skillswap_ai;

-- Track points earned per category
...
-- Milestone definitions (per category)
...
-- Seed milestones for all categories (7 tiers each)
